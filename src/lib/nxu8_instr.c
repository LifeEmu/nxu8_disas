...
struct nxu8_instr_mask instrs[] = {
	...
	{0xb000, 0x0e00, 0x08, 0x003f, 0x00, "l\ter%0d,\t%D:%1O[bp]",    NULL},
	{0xb040, 0x0e00, 0x08, 0x003f, 0x00, "l\ter%0d,\t%D:%1O[fp]",    NULL},
	{0xd000, 0x0f00, 0x08, 0x003f, 0x00, "l\tr%0d,\t%D:%1O[bp]",     NULL},
	{0xd040, 0x0f00, 0x08, 0x003f, 0x00, "l\tr%0d,\t%D:%1O[fp]",     NULL},


	{0x9033, 0x0e00, 0x08, 0x0000, 0x00, "st\ter%0d,\t%D:[ea]",        NULL},
	{0x9053, 0x0e00, 0x08, 0x0000, 0x00, "st\ter%0d,\t%D:[ea+]",       NULL},
	{0x9003, 0x0e00, 0x08, 0x00e0, 0x04, "st\ter%0d,\t%D:[er%1d]",     NULL},
	...
	{0xb080, 0x0e00, 0x08, 0x003f, 0x00, "st\ter%0d,\t%D:%1O[bp]",    NULL},
	{0xb0c0, 0x0e00, 0x08, 0x003f, 0x00, "st\ter%0d,\t%D:%1O[fp]",    NULL},
	{0xd080, 0x0f00, 0x08, 0x003f, 0x00, "st\tr%0d,\t%D:%1O[bp]",     NULL},
	{0xd0c0, 0x0f00, 0x08, 0x003f, 0x00, "st\tr%0d,\t%D:%1O[fp]",     NULL},
	...
	{0xa000, 0x0f00, 0x08, 0x0070, 0x04, "sb\t%1d,\tr%0d",           NULL},
	{0xa080, 0x0070, 0x04, 0x0000, 0x00, "sb\t%0d,\t[%2hh]",         NULL},
	{0xa001, 0x0f00, 0x08, 0x0070, 0x04, "tb\t%1d,\tr%0d",           NULL},
	{0xa081, 0x0070, 0x04, 0x0000, 0x00, "tb\t%0d,\t[%2hh]",         NULL},
	{0xa002, 0x0f00, 0x08, 0x0070, 0x04, "rb\t%1d,\tr%0d",           NULL},
	{0xa082, 0x0070, 0x04, 0x0000, 0x00, "rb\t%0d,\t[%2hh]",         NULL},
	...
	{0x810f, 0x00e0, 0x04, 0x0e00, 0x08, "extbw\ter%0d,\ter%1d", NULL},
				...
				switch (*fmt) {
					case '%': {
						...
						switch (*fmt) {
							...
							// Lemme define some new formatters here~
							case 'n':	// 'n' stands for "nibble" - I mean, I run out of ideas ;_;
								// used for immediate DSR prefixes
								// in theory DSR is 8 bits wide but eh
								head += sprintf(head, "%1X", src);
								break;
							case 'o':	// 'o' is for "offset"
								...
								break;
							case 'O':	// 'o' is for "offset"
								// used in base/frame pointer indirect addressings
								src &= 0x3F;
								head += sprintf(head, "%c%d", src & 0x20 ? '-' : '+', src & 0x20 ? ((src ^ 0x3F) + 1) & 0x3F : src);
								break;
